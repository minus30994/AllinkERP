...
-- DESCRIPTION: 返回某个成本要素(辅助项目)的可报账数(加锁)
-- =============================================

Create Function F_Management_Material_Get_Value_Lock (
...
SET @LI_TIME=(SELECT FTIME FROM T_BUDGET_FORM_DETAIL WITH(NOLOCK) WHERE FID=@LI_BUDGET_FORM_ID AND FBUDGET_ITEM_ID=@LI_BUDGET_ITEM_ID
...
SELECT
TOP 1
DBO.F_BUDGET_GET_VALUE_LOCK('已审核总下拨',@LI_BUDGET_CENTER_ID,CONVERT(VARCHAR(10),@LS_DATE,20),@LI_BUDGET_ITEM_ID,@LI_ASSISTANT_ITEM_ID)
-
DBO.F_BUDGET_GET_VALUE_LOCK('总报账',@LI_BUDGET_CENTER_ID,CONVERT(VARCHAR(10),@LS_DATE,20),@LI_BUDGET_ITEM_ID,@LI_ASSISTANT_ITEM_ID)
-
ISNULL((
SELECT
